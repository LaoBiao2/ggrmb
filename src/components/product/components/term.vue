<template>
    <div class="product-box term">
        <div class="nav-box">
            <ul>
                <li class="nav-li"
                    v-for="(dataLi, key, index) in dataList"
                    v-bind:class="{active:index==dataId}"
                    @click="test(index)">{{key}}</li>
                 <!-- <li class="nav-li active" @click="test()" >买入</li>
                <li class="nav-li">卖出</li>
                <li class="nav-li">建仓</li>
                <li class="nav-li">手数</li>
                <li class="nav-li">合约单位</li>
                <li class="nav-li" id="cs">盎司</li>
